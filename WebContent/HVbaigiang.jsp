...
<div class="row">
  ...
  <li class="r"><a href="HVthongtin.html">Thông tin</a></li>
  <li class="dropdown">
    <a class="dropdown-toggle r" data-toggle="dropdown" href="#">Khóa học
    <span class="caret"></span></a>
    <ul class="dropdown-menu">
      <li><a class="r" href="HVkhoahocdk.html">Khóa học DK</a></li>
      <li><a class="r" href="HVkhoahoc.html">Các Khóa học</a></li>
      <li><a class="r" href="HVdecuongchitiet.html">Chi tiết khóa học</a></li> 
    </ul>
  </li>
  <li><a class="r" href="HVlambai.html">Làm bài</a></li>
    <li class="dropdown">
    <a class="dropdown-toggle r" data-toggle="dropdown" href="#">Tin nhắn
    <span class="caret"></span></a>
    <ul class="dropdown-menu">
      <li><a class="r" href="HVnhaninadmin.html">Giảng viên</a></li>
      <li><a class="r" href="HVtinnhanGV.html">ADmin</a></li>
    </ul>
  </li>
  </div>
        ...
        <div class="post">
          <div class="panel panel-default">
            <div class="panel-heading">
              <p style="color:#097e23;font-size:25px">Toán 12 - Giảng viên Lê Long Kiệt</p>
            </div>
            <div class="panel-body">
                <div class="col-md-3 content">
                <h3 style="color:blue;">Các bài giảng</h4>
                <ul>
                  <li><a href="">Tuần 1</a></li>
                  <li>Tuần 2</li>
                  <li>Tuần 3</li>
                  <li>Tuần 4</li>
                </ul>
                </div> <!--end content-->
                <div class="col-md-7 sidebar" style="border:1px solid black">
                  ...
                  <tbody>
                    <tr>
                      <td><p style="color:red; font-size:16px;margin-left:0px;">Chương I. ứng dụng đạo hàm để khào sát và vẽ đồ thị</p>
                      <div class="col-md-12">
                        <video style="margin-left:50px" width="320" height="240" controls autoplay>
                          <source src="2.mp4" type="video/mp4">
                          Your browser does not support the video tag.
                        </video>
                      </div>
                      <p style="margin-left:0px" class="text-center">-Tài liệu: Toán12-chương1 <a href="Baitap.pdf" download>Tải</a></p>
