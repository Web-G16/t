        ...
        <div class="post">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h2 class="panel-little tieude text-center" >Mở khóa học mới</h2>
            ...
            <div class="panel-body">  
              <div class="row">
                <div class="col-md-12">
                  <button type="button" class="btn btn-default" style="background-color:#7dc5f3;color:white;margin-left:280px" data-dismiss="modal">Thêm thông tin cho khóa học</button>
                </div>
                <div class="col-md-12">
                  <p>1.Tên môn học:</p>
                  <p>Giảng viên phục trách môn học:</p>
                  <p>Mô tả môn học: Trang bị những kiến thức cho luyện thi đại học</p>
                  <p>Tài liệu học tập: Sách giáo khoa toán 12 (Bộ giáo dục và đào tạo Việt Nam)</p>
                </div>
                <div class="col-md-12"><h3 class="text-center" style="color:red">Kế hoạch học tập</h3>
                  ...
                  <button type="button" class="btn btn-default" style="background-color:#7dc5f3;color:white;margin-left:400px" data-dismiss="modal">Xong</button>
                </div>
